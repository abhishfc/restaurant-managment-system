...
def create_connection():
    connection = sqlite3.connect("resto.db")
...
connector = sqlite3.connect("Restaurant.db")
...
def signup_command():
    ...
    def signup():
        ...
        if password == conform_password:
            try:
                ...
                # Execute a query to insert new user data
    ...
    # Rest of your code for the signup window...
    ...
    heading=Label(frame,text='SIGN UP', fg='#57a1f8',bg='white',font=('Microsoft YaHei UI Light',25,'bold'))
    ...
    Login= Button(frame,width=6,text='Login',border=0,bg='white',cursor='hand2',fg='#57a1f8',command=Login)
    Login.place(x=193,y=320)
...
img = PhotoImage(file='exp.png')
Label(root,image=img,bg='white').place(x=50,y=50)

frame=Frame(root,width=350,height=350,bg="white")
frame.place(x=480,y=70)

heading=Label(frame,text='LOGIN', fg='#57a1f8',bg='white',font=('Microsoft YaHei UI Light',25,'bold'))
heading.place(x=100,y=5)
